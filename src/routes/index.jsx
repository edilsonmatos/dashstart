...
const Metrics = lazy(() => import('@/app/(admin)/metrics/page'));
const Cities = lazy(() => import('@/app/(admin)/cities/page'));
const AgeGender = lazy(() => import('@/app/(admin)/age-gender/page'));
const Month = lazy(() => import('@/app/(admin)/month/page'));
const Ads = lazy(() => import('@/app/(admin)/ads/page'));
